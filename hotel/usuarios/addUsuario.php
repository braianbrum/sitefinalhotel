...
<body >
    <div id="formularioCli" style="background-color:white;">
        <h1 style="padding-left:500px;">CADASTRAMENTO DE USUÁRIO</h1>
        <form method="POST" action="adicionarOKusuario.php" style="padding-left:500px;">
...
<button type="submit" name="CADASTRAR" style="background-color:green;">CADASTRAR</button>
 ...
 <div id="linkC" style="background-color:white";>
